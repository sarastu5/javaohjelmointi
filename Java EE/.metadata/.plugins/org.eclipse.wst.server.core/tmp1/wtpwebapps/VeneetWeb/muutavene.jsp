	...
	<div class="lomake">
		<form action="MuutaVene" name="muutaLomake" id="muutaLomake" method="post">
			...
			<div class="form-group row">
		  	...
		  	<button type="submit" class="btn btn-primary" value="lisää">Muuta veneen tietoja</button>
		  	<a href="listaaveneet.jsp"><button type="button" class="btn btn-light">Näytä kaikki veneet</button></a>
		</form>
	</div>
			...
			$("#muutaLomake").validate({
				...
				messages: {
					nimi: {
						...
						minlength: "Nimen pituus ei riitä",
						maxlength: "Nimi on liian pitkä"
					},
					merkkimalli: {
						required: "Kenttä on pakollinen",
						minlength: "Nimen pituus ei riitä",
